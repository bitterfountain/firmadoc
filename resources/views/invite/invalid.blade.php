...
@section('title', 'Invitación no válida · FirmaDoc')
...
@section('content')
    <div class="card mx-auto mt-10 max-w-md p-10 text-center">
        ...
        <h1 class="text-xl text-ink">Invitación no válida</h1>
        <p class="mt-2 text-sm leading-relaxed text-muted">
            Este enlace ya se ha usado o ha caducado. Pide una invitación nueva a quien te lo envió.
        </p>
        <a href="{{ url('/') }}" class="btn btn-ghost mt-6 px-5">Ir al inicio</a>
    </div>
@endsection
